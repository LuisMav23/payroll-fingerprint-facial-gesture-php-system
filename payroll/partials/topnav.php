<header class="main-header">
	<a href="<?php echo BASE_URL; ?>" class="logo">
		...
		<span class="logo-lg"><b>Employee System</b></span>
	</a>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<?php } else { ?>
							<img src="<?php echo REG_URL; ?>photos/<?php echo $userData['photo']; ?>" class="user-image"
								alt="User Image">
							<span class="hidden-xs"><?php echo $userData['first_name']; ?>
								<?php echo $userData['last_name']; ?></span>
						<?php } ?>
					</a>
					<ul class="dropdown-menu">
						<li class="user-header">
							...
							<?php } else { ?>
								<img src="<?php echo REG_URL; ?>photos/<?php echo $userData['photo']; ?>" class="img-circle"
									alt="User Image">
							<?php } ?>
							<p>
								<?php if ($_SESSION['Login_Type'] == 'admin') { ?>
