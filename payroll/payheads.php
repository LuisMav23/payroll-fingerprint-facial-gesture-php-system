					...
					<form method="POST" role="form" data-toggle="validator" id="payhead-form">
						<div class="modal-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="payhead_name" name="payhead_name"
									placeholder="Pay Head Name" required />
							</div>
							<div class="form-group">
								<label for="payhead_desc">Pay Head Description</label>
								<textarea class="form-control" id="payhead_desc" name="payhead_desc"
									placeholder="Pay Head Description" required></textarea>
							</div>
							<div class="form-group">
