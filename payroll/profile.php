											...
											<form method="POST" role="form" data-toggle="validator" id="password-form">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="admin_code" id="admin_code"
														value="<?php echo $data['admin_code']; ?>" required />
												</div>
												<div class="row">
													<div class="col-lg-6">
														<div class="form-group">
													...
													<div class="col-lg-6">
														<div class="form-group">
															...
															<input type="password" class="form-control" name="admin_password_conf"
																id="admin_password_conf" required />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="country" id="country"
																value="<?php echo $data['country']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="merital_status"
																id="merital_status" value="<?php echo $data['merital_status']; ?>"
																required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="nationality"
																id="nationality" value="<?php echo $data['nationality']; ?>"
																required />
														</div>
													</div>
													<div class="col-lg-3">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<select class="form-control" name="identity_doc" id="identity_doc"
																...
																<option value="Aadhar Card" <?php echo $data['identity_doc'] == 'Aadhar Card' ? 'selected' : ''; ?>>
																	Aadhar
																	Card</option>
																<option value="Driving License" <?php echo $data['identity_doc'] == 'Driving License' ? 'selected' : ''; ?>>
																	Driving License</option>
																<option value="Passport" <?php echo $data['identity_doc'] == 'Passport' ? 'selected' : ''; ?>>Passport
																</option>
															</select>
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="identity_no"
																id="identity_no" value="<?php echo $data['identity_no']; ?>"
																required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<select class="form-control" name="emp_type" id="emp_type" required>
																<option value="">Please make a choice</option>
																<option value="Part-time employee" <?php echo $data['emp_type'] == 'Part-time employee' ? 'selected' : ''; ?>>
																	Part-time employee</option>
																<option value="Intern" <?php echo $data['emp_type'] == 'Intern' ? 'selected' : ''; ?>>Intern</option>
																<option value="Holiday worker" <?php echo $data['emp_type'] == 'Holiday worker' ? 'selected' : ''; ?>>
																	Holiday
																	worker</option>
																<option value="Permanent position" <?php echo $data['emp_type'] == 'Permanent position' ? 'selected' : ''; ?>>
																	Permanent position</option>
															</select>
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control datepicker" name="joining_date"
																id="joining_date" value="<?php echo $data['joining_date']; ?>"
																required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="blood_group"
																id="blood_group" value="<?php echo $data['blood_group']; ?>"
																required />
														</div>
													</div>
													<div class="col-lg-3">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="department"
																id="department" value="<?php echo $data['department']; ?>"
																required />
														</div>
													</div>
												</div>
